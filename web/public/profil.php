<?php 
    ...
    <body>
        ...
        <section class="top">
            ...
            <div class="dropbtn2">
                <a href="reset_password.php?id_user=<?php echo $id_user;?>">Reset Password</a>
            </div>
            <a href="delete_user.php?id_user=<?php echo $id_user;?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer votre compte ?')" name="delete" value="Supprimer"><button class="dropbtn2">Supprimer</button></a>
        </section>
            <br><br>
        <section class="middle">
            <h1>Modifier mon Profil : <b><?php echo $email ?></b></h1>
            <br>
        </section>
        <br><br>
        <section class="corps">
